export const pl: Record<string, string> = {
  ...
  // Compound steps
  'compound.present_front.name': 'Pokaż i przeczytaj',
  'compound.flip_reveal.name': 'Odkryj odpowiedź ręcznie',
  'compound.show_all_grade.name': 'Pokaż wszystko i oceń',
  'compound.speak_pause_next.name': 'Czytaj i odkryj po pauzie',
  'compound.auto_flip.name': 'Auto-odkrycie',
  'compound.listen_grade.name': 'Oceń STT',
  'compound.grade_after_listen.name': 'Oceń po STT',
  ...
  'compound.field.reveal_style': 'Sposób odkrycia',
  'compound.field.next_page': 'Następna strona',
  'compound.field.multiplier': 'Mnożnik pauzy dynamicznej',
  ...
  'compound.field.speak_answer': 'Czytaj odpowiedź',
  'compound.field.threshold': 'Próg (%)',
  'compound.field.manual_fallback': 'Fallback ręczny',
  ...
  'compound.branch.wrong': 'Gdy źle',
  'compound.branch.feedback': 'Dźwięk feedbacku',
  'compound.branch.speak_enabled': 'Czytaj stronę',
  'compound.branch.reveal_all': 'Odkryj wszystkie strony',
  'compound.branch.mark_failed': 'Oznacz failed',
  'compound.branch.advance': 'Przejdź do kolejnej karty',
  'compound.pause.none': 'Bez pauzy',
  'compound.pause.fixed': 'Stała pauza',
  'compound.pause.dynamic': 'Zależna od długości strony',
  'compound.rate.from_answer': 'Z wyniku STT',
  'compound.rate.fixed': 'Stała ocena',
  'compound.rate.none': 'Bez oceny',
  'compound.reveal.all': 'Odkryj resztę stron',
  'compound.reveal.next': 'Odkryj następną stronę',
